...
#link github: https://github.com/princeton-vl/pytorch_stacked_hourglass
#paper: Stacked Hourglass Networks for Human Pose Estimation (2016)
...
class PoseNet(nn.Module):
    def __init__(self, nstack=8, inp_dim=256, oup_dim=16, bn=False, increase=0, **kwargs):
